                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Text('Subtotal (${4} items):',style: Styles.textStyle12.copyWith(color: CustomColors.darkGrey,fontWeight: FontWeight.w400),),
                            Spacer(),
                            Text('\$${395.00}',style: Styles.textStyle16.copyWith(color: CustomColors.darkGrey),)
                          ],
                        ),
                        Row(
                          children: [
                            Text('Delivery cost:',style: Styles.textStyle12.copyWith(color: CustomColors.darkGrey,fontWeight: FontWeight.w400),),
                            Spacer(),
                            Text('\$${6.70}',style: Styles.textStyle16.copyWith(color: CustomColors.darkGrey),)
                          ],
                        ),
                        Row(
                          children: [
